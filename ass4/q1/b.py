...
known_face_encodings = [ passport_face_encoding ]
known_face_names = [ passport_filename ]
...
for i in range(2,451): 
    ...
    # unknown_image = face_recognition.load_image_file("faces/image_0002.jpg")
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        print(i, unknown_filename, face_distances)
