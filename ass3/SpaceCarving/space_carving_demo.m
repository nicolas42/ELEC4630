% from https://au.mathworks.com/matlabcentral/fileexchange/26160-carving-a-dinosaur
...
disp("Create a Voxel Array...");
% number_of_voxels = 100000
voxels = makevoxels( xlim, ylim, zlim, number_of_voxels );
